...
class View(discord.ui.View):
    ...
    def add_buttons(self):
        self.homeB = discord.ui.Button(label="", emoji="<:rewind:1500793294865563658>", style=discord.ButtonStyle.secondary)
        self.homeB.callback = self.home_callback

        self.backB = discord.ui.Button(label="", emoji="<:next:1448949316109733920>", style=discord.ButtonStyle.secondary)
        self.backB.callback = self.back_callback

        self.quitB = discord.ui.Button(label="", emoji="<:remove:1538160153449205851>", style=discord.ButtonStyle.danger)
        self.quitB.callback = self.quit_callback

        self.nextB = discord.ui.Button(label="", emoji="<:next:1448949316109733920>", style=discord.ButtonStyle.secondary)
        self.nextB.callback = self.next_callback

        self.lastB = discord.ui.Button(label="", emoji="▶️", style=discord.ButtonStyle.secondary)
