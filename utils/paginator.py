...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:rewind:1500793294865563658>'
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:next:1448949316109733920>'
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:next:1448949316109733920>'
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '▶️'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<:remove:1538160153449205851>'
