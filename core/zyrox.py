...
class zyrox(commands.AutoShardedBot):
    ...
    async def status_task(self):
        ...
        self.status_list = [
            (discord.ActivityType.playing, f"{prefix}help | NEON~V2"),
            (discord.ActivityType.watching, f"{user_count} users of server"),
            (discord.ActivityType.watching, f"{guild_count} servers"),
            (discord.ActivityType.listening, "Killing Noobs"),
            (discord.ActivityType.playing, "Protector pro"),
            (discord.ActivityType.playing, "NEON~V2 | Official"),
            (discord.ActivityType.playing,"🤑 money"),
        ]
