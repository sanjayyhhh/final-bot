...
class Status(commands.Cog):
    ...
    async def status(self, ctx, user: discord.User = None):
        ...
        processing = await ctx.send("<a:loading:1538161262997930094> Loading Status...")
        embed = discord.Embed(title=f"{user.display_name}'s Status", color=0xFF0000)

        status_emoji = {
            "online": "<a:online:1538163456161878016> Online",
            "idle": "🥱 Idle",
            "dnd": "🥱 Do Not Disturb",
            "offline": "<a:online:1538163456161878016>  Offline"
        }
        ...
        if member:
            status = status_emoji.get(str(member.status), "<a:online:1538163456161878016> Offline")
            ...
            try:
                ...
                embed.add_field(name="Status:", value="<a:online:1538163456161878016> Offline", inline=False)
