...
class afk(commands.Cog):
    ...
    async def clear_afk(self, message):
        async with aiosqlite.connect(DB_PATH) as db:
            ...
            embed = discord.Embed(
                ...
                description=f"<a:Verified:1535986177264324628> **AFK Removed**\n<a:announce:1536982399152558170> **Mentions:** {mentions}\n⏰ **AFK Time:** {elapsed_time}",
    ...
    async def afk(self, ctx: commands.Context, *, reason: str = "I am AFK"):
        ...
        confirm_embed = discord.Embed(
            title="<a:Verified:1535986177264324628> AFK Activated",
            description=f"**<a:announce:1536982399152558170> You are now marked as {type_view.value.capitalize()} AFK.**\n<:plants:1537808028252774402> **Reason:** {reason}",
            color=self.theme_color
        )
