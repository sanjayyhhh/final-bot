    ...
    async def extraowner(self, ctx, option: str = None, user: discord.Member = None):
        ...
        if option.lower() == 'set':
            ...
            if view.value is None:
                ...
                await message.edit(content="<a:Cross:1536000244716802072> Action cancelled.", embed=None, view=None)
            ...
            if not row:
                ...
                if view.value is None:
                    ...
                    await message.edit(content="<a:Verified:1535986177264324628> Action canceled.", embed=None, view=None)
