...
class Antinuke(commands.Cog):
  ...
  async def antinuke(self, ctx, option: str = None):
    ...
    if option is None:
      embed = discord.Embed(
        title='<:zSafe:1448951403434479626> NEON~V2 Security',
      ...
      if is_activated:
        ...
        setup_embed.description += "\n<:ztick:1448951767990796298> Checking NEON~V2's role position for optimal configuration..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:ztick:1448951767990796298> | Crafting and configuring the NEON~V2 Supreme role..."
        await setup_message.edit(embed=setup_embed)
        ...
        await asyncio.sleep(1)
        setup_embed.description += "\n<:ztick:1448951767990796298>| Ensuring precise placement of the NEON~V2 Supreme™ role..."
        await setup_message.edit(embed=setup_embed)
        try:
