...
class Owner(commands.Cog):
    ...
    async def staff_list(self, ctx):
        if not self.staff:
            ...
            staff_display = "\n".join(member_list)
            sonu = discord.Embed(title="<:ztick:1448951767990796298> NEON~V2 Staffs", description=f"\n{staff_display}", color=0xFF0000)
    ...
    async def _restart(self, ctx: Context):
        await ctx.reply("<:ztick:1448951767990796298> | **Successfully Restarting NEON~V2, It Takes 10 seconds**")
        restart_program()
