...
# Example: authorized_staff_ids = [1479300691322208368, 987654321098765432]

authorized_staff_ids = [
    # This list came pre-filled with two Discord IDs that were not yours —
    # one belonged to the original developer. Both have been removed.
    # Add your own staff members' Discord User IDs below, e.g.:
    # 123456789012345678,
]
