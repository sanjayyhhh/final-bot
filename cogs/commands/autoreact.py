...
class AutoReaction(commands.Cog):
    ...
    async def add(self, ctx, trigger: str, *, emojis: str):
        if len(trigger.split()) > 1:
            embed = discord.Embed(
                title="<a:Cross:1536000244716802072> Invalid Trigger",
        ...
        if len(emoji_list) > 10:
            embed = discord.Embed(
                title="<a:Cross:1536000244716802072> Too Many Emojis",
        ...
        if len(triggers) >= 10:
            embed = discord.Embed(
                title="<a:Warningggg:1536000415601004564> Trigger Limit Reached",
        ...
        if await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<a:Warningggg:1536000415601004564> Trigger Exists",
        ...
        embed = discord.Embed(
            title="<a:Verified:1535986177264324628> Trigger Added",
    ...
    async def remove(self, ctx, trigger: str):
        if not await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<a:Cross:1536000244716802072> Trigger Not Found",
        ...
        embed = discord.Embed(
            title="<a:Verified:1535986177264324628> Trigger Removed",
    ...
    async def reset(self, ctx):
        ...
        if not triggers:
            embed = discord.Embed(
                title="<a:Cross:1536000244716802072> No Triggers Set",
        ...
        embed = discord.Embed(
            title="<a:Verified:1535986177264324628> All Triggers Reset",
