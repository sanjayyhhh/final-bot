...
class Block(commands.Cog):
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        ...
        await db.commit()
        embed = discord.Embed(
          title="<a:Verified:1535986177264324628> User Blacklisted",
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<a:Cross:1536000244716802072> User Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<a:Verified:1535986177264324628> User Unblacklisted",
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<a:Cross:1536000244716802072> No Blacklisted Users",
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<a:Cross:1536000244716802072> Guild Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<a:Verified:1535986177264324628> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<a:Cross:1536000244716802072> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<a:Verified:1535986177264324628> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<a:Cross:1536000244716802072> No Blacklisted Guilds",
