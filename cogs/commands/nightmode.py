...
class Nightmode(commands.Cog):
    ...
    async def enable_nightmode(self, ctx):
        if ctx.guild.member_count < 50:  
            return await ctx.send(embed=discord.Embed(title=" <a:Cross:1536000244716802072> Access Denied",
                color=self.color,
        ...
        if not own and not (
            ...
            return await ctx.send(embed=discord.Embed(title="<a:Warningggg:1536000415601004564> Access Denied",
                color=self.color,
        ...
        if not manageable_roles:
            return await ctx.send(embed=discord.Embed(title="<a:Cross:1536000244716802072> Error",
                color=self.color,
        ...
        await ctx.send(embed=discord.Embed(title="<a:Verified:1535986177264324628> Success",
            color=self.color,
