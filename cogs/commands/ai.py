...
class PersonalityModal (discord .ui .Modal ,title ="Set Your AI Personality"):
    def __init__ (self ,ai_cog ,current_personality :str =""):
        ...
        default_prompt ="""You are NEON~V2, an intelligent and caring Discord bot assistant! 💕
...
Ready to have meaningful conversations and help with anything you need! 💖"""
        ...
        placeholder ="Describe how you want NEON~V2 to respond to you...",
    ...
    async def _get_response (self ,message :str ,history :list ,guild_id :int ,user_id :int =None )->str :
        try :
            ...
            if user_personality :
                ...
                system_context .append ({
                "role":"system",
                "content":"You are a Discord bot with many features including moderation, entertainment, music, games, AI capabilities, and utilities. Support server: PASTE_YOUR_OWN_SUPPORT_SERVER_INVITE_HERE"
                })
            else :

                system_context .append ({
                "role":"system",
                "content":f"""You are NEON~V2, an intelligent Discord bot. 
...
Support server: PASTE_YOUR_OWN_SUPPORT_SERVER_INVITE_HERE"""
                })
    ...
    async def ai_activate (self ,ctx :commands .Context ,channel :discord .TextChannel =None ):
        ...
        if not ctx .author .guild_permissions .manage_channels :
            embed =discord .Embed (
            title ="<a:Cross:1536000244716802072> Permission Denied",
        ...
        embed =discord .Embed (
        title ="<a:Verified:1535986177264324628> AI Chatbot Activated",
    ...
    async def handle_trivia_answer (self ,interaction :discord .Interaction ,channel_id :int ,selected_answer :str ):
        ...
        if is_correct 
        else f"<a:Cross:1536000244716802072> Incorrect. The answer was **{game['current_answer']}**. Your guess: **{selected_answer}**. -1 point."
        )
