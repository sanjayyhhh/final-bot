...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        button_send = Button(label="Send Embed",  emoji="<a:Verified:1535986177264324628>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<a:Cross:1536000244716802072>", style=discord.ButtonStyle.danger)
