...
class MapView(ui.View):
    ...
    def get_coordinates(self, location):
        ...
        try:
            headers = {'User-Agent': 'NEON~V2 Bot'}
    ...
    async def update_embed(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Made by NEON~V2 Development™")
        try:
    ...
    @discord.ui.button(label="", emoji="<:remove:1538160153449205851>", style=ButtonStyle.danger)
