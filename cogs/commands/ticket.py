...
# --- Emoji Variables ---
SUCCESS_EMOJI = "<a:Verified:1535986177264324628>"
ERROR_EMOJI = "<a:Warningggg:1536000415601004564>"
LOCK_EMOJI = "<:unlock:1448949560457171070> "
UNLOCK_EMOJI = "<a:lock_key:1535986624788439041>"
CLAIM_EMOJI = "<a:float_gift:1535984187431976981>"
CLOSE_EMOJI = "<a:Cross:1536000244716802072>"
DELETE_EMOJI = "<a:Cross:1536000244716802072>"
REOPEN_EMOJI = "🔧"
TRANSCRIPT_EMOJI = "<:link:1536000681956343928>"
...
async def get_or_create_log_channel(db, guild):
    ...
    try:
        ch = await guild.create_text_channel("neonv2-ticket-logs", overwrites=overwrites)
