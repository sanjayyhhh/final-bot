    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if self.values[0] == "Home":
            ...
            embed.description = (
                ...
                "**[Invite NEON~V2](PASTE_YOUR_OWN_BOT_INVITE_URL_HERE)**\n"
                "**[Join Support Server](PASTE_YOUR_OWN_SUPPORT_SERVER_INVITE_HERE)**"
            )

        embed.set_footer(text="Powered by toxico™", icon_url=self.bot.user.avatar.url)
